...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    for num_of_hands in range(total_num_of_hands):
        if num_of_hands > 0:
            answer_to_replay_hand_question = input('Would you like to replay another hand?')
        ...
        answer_to_substitue_question = input('Would you like to substitute another letter? ')
        if answer_to_substitue_question == 'yes':
